...
<table border="1" class="bordered-table">
  ...
  <tr>
    ...
    <td style="padding:15px">Provides a connectivity check to the Tufin_securetrack system.</td>
  </tr>
  <tr>
    <td style="padding:15px">npm run healthcheck</td>
    <td style="padding:15px">Checks whether the configured healthcheck call works to Tufin_securetrack.</td>
  </tr>
  <tr>
    <td style="padding:15px">npm run basicget</td>
    <td style="padding:15px">Checks whether the basic get calls works to Tufin_securetrack.</td>
  </tr>
</table>
<br>
