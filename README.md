...
1. Add the adapter properties for Tufin_securetrack (created from Adapter Builder) to the `properties.json` file for your Itential build. You will need to change the credentials and possibly the host information below.
[Tufin_securetrack sample properties](sampleProperties.json)
